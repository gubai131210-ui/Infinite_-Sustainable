...
func _mountains() -> void:
	## Tall seamless skyline + irregular pine canopy lobes (P161: break stripe bands).
	_spr("res://assets/processed/prop_skyline_wide.png", Vector2(96, 0), 1, 1.0, Vector2.ZERO, Color(1, 1, 1, 1), false)
	# Staggered / offset lobes — same atlas, different Y + tint (not 3 stacked bars)
...
func _town() -> void:
	## Overview silhouette: lived-in asymmetric plaza (break mirror layout)
	_spr("res://assets/processed/prop_statue.png", Vector2(87, 71), 7, 1.2, Vector2(18, 22))
	_spr("res://assets/processed/prop_flowerbed.png", Vector2(82, 67), 4, 1.0)
	_spr("res://assets/processed/prop_flowerbed.png", Vector2(98, 65), 4, 1.0)
	_spr("res://assets/processed/prop_bench.png", Vector2(84, 73), 4, 1.05)
	_spr("res://assets/processed/prop_bench.png", Vector2(96, 70), 4, 1.05)
	_spr("res://assets/processed/prop_lamp.png", Vector2(78, 63), 5, 1.1)
	_spr("res://assets/processed/prop_lamp.png", Vector2(102, 66), 5, 1.1)
	_spr("res://assets/processed/prop_lamp.png", Vector2(70, 50), 5, 1.05)
	_spr("res://assets/processed/prop_lamp.png", Vector2(110, 54), 5, 1.05)
	# Hero shop / cafe / bakery — slight Y offset kills symmetry
	_spr("res://assets/processed/prop_shop_awning.png", Vector2(76, 49), 10, 1.55, Vector2(52, 28))
	_spr("res://assets/processed/prop_cafe_awning.png", Vector2(104, 51), 10, 1.55, Vector2(52, 28))
	_spr("res://assets/processed/prop_bakery.png", Vector2(92, 61), 10, 1.45, Vector2(40, 22))
	_spr("res://assets/processed/prop_doormat.png", Vector2(76, 53), 3, 1.0)
	_spr("res://assets/processed/prop_doormat.png", Vector2(104, 55), 3, 1.0)
	_spr("res://assets/processed/prop_crate.png", Vector2(70, 53), 4, 0.95)
	_spr("res://assets/processed/prop_barrel.png", Vector2(110, 55), 4, 0.95)
	_spr("res://assets/processed/prop_crate.png", Vector2(88, 57), 4, 0.9)
	_spr("res://assets/processed/prop_barrel.png", Vector2(96, 59), 4, 0.9)
	# Stalls — irregular ring (not mirrored pairs)
	_spr("res://assets/processed/prop_stall.png", Vector2(74, 69), 6, 1.1, Vector2(28, 16))
	_spr("res://assets/processed/prop_stall_blue.png", Vector2(106, 72), 6, 1.1, Vector2(28, 16))
	_spr("res://assets/processed/prop_stall_yellow.png", Vector2(68, 56), 6, 1.0, Vector2(26, 16))
	_spr("res://assets/processed/prop_stall.png", Vector2(112, 60), 6, 1.0, Vector2(26, 16))
	_spr("res://assets/processed/prop_stall_blue.png", Vector2(80, 76), 6, 0.95, Vector2(24, 14))
	_spr("res://assets/processed/prop_stall_yellow.png", Vector2(100, 73), 6, 0.95, Vector2(24, 14))
	for p in [Vector2(82, 53), Vector2(98, 56), Vector2(85, 67), Vector2(94, 64), Vector2(90, 70)]:
		_spr("res://assets/processed/prop_planter.png", p, 5, 1.0)
	for tp in [Vector2(56, 42), Vector2(124, 46), Vector2(48, 64), Vector2(132, 60), Vector2(72, 84), Vector2(112, 80)]:
