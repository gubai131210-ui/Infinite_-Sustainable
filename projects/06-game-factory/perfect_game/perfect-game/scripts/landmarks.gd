...
func _town() -> void:
	# Open plaza — statue alone; stalls on sides
...
func _lake() -> void:
	_spr("res://assets/processed/prop_lighthouse.png", Vector2(174, 100), 11, 1.25, Vector2(30, 72))
	...
	# Shore houses on sand/fringe — avoid lake water
