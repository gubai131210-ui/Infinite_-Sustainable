...
func _capture_goldens(player: Node2D = null) -> void:
	...
	for s in shots:
		...
		if is_overview:
			## Slightly tighter poster crop — more town/farm weight, less empty north void
